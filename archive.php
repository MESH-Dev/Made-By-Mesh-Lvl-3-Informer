			...
			<div class="row">
				<div class="sign sf">
					<h1 id="welcomeTitle" class="pf">
						...
						<?php if ( is_day() ) : ?>
							<?php printf( __( 'Daily '.$blog_title.' Articles: <span>%s</span>' ), get_the_date() ); ?>
						<?php elseif ( is_month() ) : ?>
							<?php printf( __( 'Monthly '.$blog_title.' Articles: <span>%s</span>' ), get_the_date('F Y') ); ?>
						<?php elseif ( is_year() ) : ?>
							<?php printf( __( 'Yearly '.$blog_title.' Articles: <span>%s</span>' ), get_the_date('Y') ); ?>
						<?php else : ?>
							<?php echo $blog_title; ?>
						<?php endif; ?>
